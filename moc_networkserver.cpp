...
#include <memory>
#include "../Retele-Server/networkserver.h"
...
QT_MOC_LITERAL(3, 24, 8), // "closeAll"
QT_MOC_LITERAL(4, 33, 17), // "OnMessageReceived"
QT_MOC_LITERAL(5, 51, 4), // "text"
QT_MOC_LITERAL(6, 56, 11), // "StartServer"
QT_MOC_LITERAL(7, 68, 9), // "RelayText"
QT_MOC_LITERAL(8, 78, 9), // "ListenCon"
QT_MOC_LITERAL(9, 88, 9) // "CloseDown"

    },
    "NetworkServer\0finished\0\0closeAll\0"
    "OnMessageReceived\0text\0StartServer\0"
    "RelayText\0ListenCon\0CloseDown"
};
...
void NetworkServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { int _r = _t->StartServer();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 4: { int _r = _t->RelayText((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 5: { int _r = _t->ListenCon();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 6: { int _r = _t->CloseDown();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
        ...
        {
            using _t = void (NetworkServer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkServer::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (NetworkServer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkServer::closeAll)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (NetworkServer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkServer::OnMessageReceived)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject NetworkServer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_NetworkServer.data,
...
// SIGNAL 2
void NetworkServer::OnMessageReceived(QString _t1)
{
