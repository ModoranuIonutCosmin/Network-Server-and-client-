...
#include <memory>
#include "../Retele-Server/serverwindow.h"
...
QT_MOC_LITERAL(1, 13, 12), // "UpdateUiText"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "text"
QT_MOC_LITERAL(4, 32, 11) // "CloseServer"

    },
    "ServerWindow\0UpdateUiText\0\0text\0"
    "CloseServer"
};
...
void ServerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->UpdateUiText((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->CloseServer(); break;
        default: ;
        }
    }
}
